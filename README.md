...
If you want to include TypeScriptAST.Corrected in your project, you can [install it directly from NuGet](https://www.nuget.org/packages/TypeScriptAST.Corrected/)
